...
const Counter = () => {
  ...
  const increaseHandler = () => {
    dispatchFunction(counterActions.increase(STEP));
  }
  ...
  return (
    <main className={classes.counter}>
      ...
      <div>
        ...
        <button onClick={increaseHandler}>+{STEP}</button>
...
//            </div>
//            <button onClick={this.toggleCounterHandler.bind(this)}>Спрятать / Показать</button>
//          </main>
//     );
//   }
// }
